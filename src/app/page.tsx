      ...
      <header className="sticky top-0 z-10 bg-white/90 dark:bg-gray-950/90 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 py-2 flex justify-between items-center">
          ...
          <div className="flex-1 flex gap-2 justify-end">
            ...
            <Button
              onClick={() =>
                router.push('https://github.com/SynapseStack')
              }
            >
          ...
          <div className="text-center mb-8">
            ...
            >
              <Image
                ...
                width={150}
                height={150}
                src={`/logos/ChatGPT Image Apr 18, 2025, 04_50_18 PM.png`}
              />
            ...
            >
             SynapseStack is a modular AI agent platform that routes tasks to specialized models for summarization, code generation, vision, and more. Built for flexibility,
            </motion.p>
          </div>
      ...
      <footer className="sticky bottom-0 z-10 bg-white/90 dark:bg-gray-950/90 backdrop-blur-sm border-t border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 py-3 text-center text-gray-600 dark:text-gray-400">
          <div className="flex justify-end items-center space-x-4">
            ...
            <div className="flex text-sm text-right gap-3 items-center">
              <p>
                Built with ❤️ by <strong>Harsh Bhatt</strong>
              </p>
            </div>
          </div>
        </div>
